...
// Nutrient IDs we care about (USDA FDC nutrient numbers)
const NUTRIENT_MAP = {
  1008: 'calories',
  1003: 'protein',
  1005: 'carbs',
...
function extractNutrients(fdcFood) {
  ...
  for (const n of list) {
    const num = n.nutrient?.number ? Number(n.nutrient.number) : n.nutrientNumber ? Number(n.nutrientNumber) : null;
